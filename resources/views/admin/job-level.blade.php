...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6 gap-3">
        <div class="min-w-0">
            <h3 class="text-base font-bold text-gray-800">Job Level</h3>
            <p class="text-[13px] text-gray-400 mt-1 font-medium">Total {{ $jobLevels->total() }} job level terdaftar</p>
        </div>
        <a href="{{ route('admin.job-level.create') }}"
            ...
            <span class="hidden sm:inline">Tambah Job Level</span>
    ...
    <div class="bg-white border border-gray-100 rounded-2xl p-5 mb-5 shadow-[0_2px_8px_rgba(16,24,40,0.05)]">
        <form method="GET" action="{{ route('admin.job-level.index') }}" class="flex flex-wrap items-center gap-3.5">
                        ...
                        <tr class="border-b border-gray-50 last:border-0 hover:bg-gray-50/60 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.job-level.edit', $item->id) }}"
                                    ...
                                    <form method="POST" action="{{ route('admin.job-level.destroy', $item->id) }}"
                                        class="delete-job-level-form">
                                        @csrf @method('DELETE')
                                        <button type="submit"
    ...
    <div id="delete-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl max-w-sm w-full mx-4 p-6 text-center"
            ...
            <h3 class="text-[15px] font-bold text-gray-800 mb-1.5">Hapus Job Level?</h3>
            <p class="text-[13px] text-gray-400 mb-6">Job level yang masih digunakan karyawan tidak dapat dihapus.</p>
    ...
    <script>
        ...
        (function() {
            ...
            document.querySelectorAll('.delete-job-level-form').forEach(function(form) {
