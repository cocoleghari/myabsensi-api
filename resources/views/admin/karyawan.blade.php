...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6 gap-3">
        <div class="min-w-0">
            <h3 class="text-base font-bold text-gray-800">Data Karyawan</h3>
            <p class="text-[13px] text-gray-400 mt-1 font-medium">Total {{ $karyawan->total() }} karyawan terdaftar</p>
        </div>
    ...
    <div class="bg-white border border-gray-100 rounded-2xl p-5 mb-5 shadow-[0_2px_8px_rgba(16,24,40,0.05)]">
        <form method="GET" action="{{ route('admin.karyawan.index') }}" class="flex flex-wrap items-center gap-3.5">
            ...
            <select name="department_id"
                class="filter-select text-[13.5px] border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:border-orange-400 focus:ring-3 focus:ring-orange-50 transition-all">
    ...
    <div class="sm:hidden space-y-3">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex items-center gap-1.5 flex-shrink-0">
                        ...
                        <a href="{{ route('admin.karyawan.show', $item->id) }}"
                            class="w-9 h-9 flex items-center justify-center rounded-lg border border-gray-200 text-gray-400 hover:text-emerald-600 hover:border-emerald-200 transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        @empty
            <div
                ...
                <p class="text-[13.5px] text-gray-400">Tidak ada data karyawan</p>
            </div>
        @endforelse
    </div>
                ...
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50/70">
                        <th class="text-left px-6 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">
                            Karyawan</th>
                        <th class="text-left px-4 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">NIK
                        </th>
                        <th class="text-left px-4 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">
                            Departemen</th>
                        <th class="text-left px-4 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Posisi
                        </th>
                        ...
                        <tr class="border-b border-gray-50 last:border-0 hover:bg-gray-50/60 transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3.5">
                                    ...
                                    @endif
                                    <div>
                                        <p class="text-[13.5px] font-semibold text-gray-800">{{ $item->full_name }}</p>
                                        <p class="text-[12px] text-gray-400 mt-0.5">
                                            {{ $item->employee_code ?? ($item->user?->email ?? '-') }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 py-4 text-[13.5px] text-gray-600 font-medium">{{ $item->nik ?? '-' }}</td>
    ...
    <div id="delete-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl max-w-sm w-full mx-4 p-6 text-center"
            ...
            <h3 class="text-[15px] font-bold text-gray-800 mb-1.5">Hapus Data Karyawan?</h3>
            <p class="text-[13px] text-gray-400 mb-6">Data yang sudah dihapus tidak dapat dikembalikan. Pastikan kamu yakin
