...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6 gap-3">
        <div class="min-w-0">
            <h3 class="text-base font-bold text-gray-800">Pengaturan Lokasi</h3>
            <p class="text-[13px] text-gray-400 mt-1 font-medium">Total {{ $lokasi->total() }} pusat lokasi terdaftar</p>
        </div>
                    ...
                    @forelse ($lokasi as $item)
                        <tr class="border-b border-gray-50 last:border-0 hover:bg-gray-50/60 transition-colors">
                            <td class="px-6 py-4">
                                ...
                                <p class="text-[12px] text-gray-400 mt-0.5 max-w-[220px] truncate">
                                    {{ $item->keterangan ?? '-' }}</p>
                            </td>
                            ...
                            <td class="px-4 py-4">
                                <button type="button"
                                    ...
                                    class="text-[11.5px] px-3 py-1.5 rounded-full bg-blue-50 text-blue-700 font-semibold hover:bg-blue-100 transition-colors cursor-pointer">
    ...
    <div id="delete-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl max-w-sm w-full mx-4 p-6 text-center"
            ...
            <h3 class="text-[15px] font-bold text-gray-800 mb-1.5">Hapus Pusat Lokasi?</h3>
            <p class="text-[13px] text-gray-400 mb-6">Lokasi yang masih digunakan karyawan tidak dapat dihapus.</p>
        ...
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full mx-4 max-h-[80vh] flex flex-col"
            ...
            <div class="p-5 border-b border-gray-100 flex items-center justify-between gap-3 flex-shrink-0">
                <div class="min-w-0">
                    ...
                    <p class="text-[12px] text-gray-400 mt-0.5" id="employee-modal-count">-</p>
                </div>
        ...
        function renderEmployeeModalList(data) {
            ...
            listEl.innerHTML = data.map(function(emp) {
                return '<div class="px-5 py-3">' +
                    ...
                    '<p class="text-[12px] text-gray-400 mt-0.5">' + emp.position_name + ' · ' + emp
                    .department_name + '</p>' +
                    '</div>';
            }).join('');
        }
