    ...
    <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-[0_2px_8px_rgba(16,24,40,0.05)]">
        <form method="POST"
            ...
            <div class="flex items-center gap-4 mt-7 pt-6 border-t border-gray-100">
                <button type="submit"
                    class="flex items-center gap-2 text-[13.5px] font-semibold px-6 py-3 rounded-xl text-white shadow-[0_3px_10px_rgba(249,115,22,0.3)] hover:opacity-90 transition-opacity"
                ...
                <a href="{{ route('admin.department.index') }}"
                    class="text-[12px] text-gray-400 hover:text-gray-600 transition-colors font-medium">Batal</a>
            </div>
        </form>
    </div>
