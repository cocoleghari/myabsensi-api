...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6 gap-3">
        <div class="min-w-0">
            <h3 class="text-sm font-bold text-gray-800">Status Karyawan</h3>
            <p class="text-[11.5px] text-gray-400 mt-1 font-medium">Total {{ $statuses->total() }} status terdaftar</p>
        </div>
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50/70">
                        <th class="text-left px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Label
                        </th>
                        <th class="text-left px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Kode
                        </th>
                        <th class="text-left px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-wider">
                            Karyawan</th>
                        <th class="text-left px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Tampil
                            di Mobile</th>
                    ...
                    @forelse ($statuses as $item)
                        <tr class="border-b border-gray-50 last:border-0 hover:bg-gray-50/60 transition-colors">
                            ...
                            <td class="px-4 py-3">
                                @if ($item->is_visible)
                                    <span
                                        class="text-[11px] px-2.5 py-1 rounded-full bg-blue-50 text-blue-700 font-semibold">Ya</span>
                                @else
                                    <span
                                        class="text-[11px] px-2.5 py-1 rounded-full bg-gray-100 text-gray-500 font-semibold">Tidak</span>
                                @endif
                            </td>
                            <td class="px-4 py-3">
                                @if ($item->is_active)
    ...
    <div id="delete-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl max-w-sm w-full mx-4 p-5 text-center"
            ...
            <h3 class="text-[13.5px] font-bold text-gray-800 mb-1">Hapus Status Karyawan?</h3>
            <p class="text-[12px] text-gray-400 mb-4">Status yang masih digunakan karyawan tidak dapat dihapus.</p>
