...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6 gap-3">
        <div class="min-w-0">
            <h3 class="text-sm font-bold text-gray-800">Department</h3>
            <p class="text-[11.5px] text-gray-400 mt-1 font-medium">Total {{ $departments->total() }} department terdaftar
            </p>
        </div>
        <div class="flex items-center gap-2.5 flex-shrink-0">
            <button type="button" onclick="openTreeModal()"
                class="flex items-center gap-2 px-3 py-2 rounded-xl text-[12.5px] font-semibold border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors">
                ...
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50/70">
                        ...
                        <th class="text-left px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-wider">
                            Company</th>
                        <th class="text-left px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Parent
                        </th>
                        <th class="text-left px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-wider">
                            Manager</th>
                        <th class="text-left px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-wider">
        ...
        <div class="bg-white rounded-2xl shadow-xl max-w-lg w-full max-h-[80vh] flex flex-col"
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100 flex-shrink-0">
                <div>
                    ...
                    <p id="employees-modal-subtitle" class="text-[11px] text-gray-400 mt-0.5"></p>
                </div>
    ...
    <div id="delete-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl max-w-sm w-full mx-4 p-5 text-center"
            ...
            <h3 class="text-[13.5px] font-bold text-gray-800 mb-1">Hapus Department?</h3>
            <p class="text-[12px] text-gray-400 mb-4">Department yang sudah dihapus tidak dapat dikembalikan.</p>
            <div class="flex gap-3">
