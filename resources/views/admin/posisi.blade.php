...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6 gap-3 flex-wrap">
        <div class="min-w-0">
            <h3 class="text-base font-bold text-gray-800">Posisi / Jabatan</h3>
            <p class="text-[13px] text-gray-400 mt-1 font-medium">Total {{ $positions->total() }} posisi terdaftar</p>
        </div>
    ...
    <div class="bg-white border border-gray-100 rounded-2xl p-5 mb-5 shadow-[0_2px_8px_rgba(16,24,40,0.05)]">
        <form method="GET" action="{{ route('admin.posisi.index') }}" class="flex flex-wrap items-center gap-3.5">
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50/70">
                        <th class="text-left px-6 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Posisi
                        </th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-12 text-center text-[13.5px] text-gray-400">Tidak ada data
                                posisi</td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <div id="delete-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl max-w-sm w-full mx-4 p-6 text-center"
            ...
            <h3 class="text-[15px] font-bold text-gray-800 mb-1.5">Hapus Posisi?</h3>
            <p class="text-[13px] text-gray-400 mb-6">Posisi yang masih dipakai karyawan tidak dapat dihapus.</p>
